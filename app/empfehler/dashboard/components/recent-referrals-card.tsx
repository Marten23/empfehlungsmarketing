    ...
    <section className="rounded-2xl border border-violet-200/55 bg-white/82 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.95)]">
      <div className="flex items-center justify-between gap-3">
        ...
        <Link
          ...
          className="group inline-flex items-center gap-2 text-sm text-violet-700 underline decoration-violet-300/60 underline-offset-4 transition-all duration-300 hover:text-violet-900 hover:decoration-violet-500/90 hover:drop-shadow-[0_0_8px_rgba(139,92,246,0.25)]"
        >
      ...
      {items.length === 0 ? (
        ...
        <ul className="mt-4 space-y-2">
          {items.map((item) => (
            <li
              key={item.id}
              className="group relative flex items-center justify-between overflow-hidden rounded-xl bg-violet-50/80 px-3 py-2 ring-1 ring-violet-200/70 shadow-[inset_0_1px_0_rgba(255,255,255,0.95)] transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.01] hover:bg-violet-50 hover:brightness-[1.04] hover:ring-violet-400/65 hover:shadow-[0_14px_26px_rgba(76,29,149,0.2)]"
            >
              ...
              <div>
                <p className="text-sm font-medium text-zinc-900">
                  <span className="mr-2 inline-flex h-6 w-6 items-center justify-center rounded-full bg-violet-200/70 text-xs font-semibold text-violet-800">
