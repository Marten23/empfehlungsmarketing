...
export function LinkToolCard({
  ...
  return (
    <article className="rounded-2xl border border-orange-200/60 bg-orange-50/78 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.92)]">
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="rounded-full border border-orange-300/55 bg-orange-100/80 px-2.5 py-1 text-[11px] font-semibold text-orange-800">
      ...
      <div className="mt-3 rounded-xl border border-orange-200/70 bg-white/88 p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
