-- =========================================================
-- 012_referrer_signup_onboarding.sql
-- Authenticated onboarding from referrer invite link
-- =========================================================
...
begin
  ...
  values (
    ...
    true,
    'Direkte Registrierung ueber Empfehler-Einladungslink am ' || timezone('utc', now())
  )
...
revoke all on function public.complete_referrer_signup_from_invite(text, uuid, text, text, text) from public;
grant execute on function public.complete_referrer_signup_from_invite(text, uuid, text, text, text) to authenticated;
